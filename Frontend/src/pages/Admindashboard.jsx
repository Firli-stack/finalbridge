      ...
      <style>{`
        ...
        * {
        ...
        .sidebar {
          ...
          min-height: 100vh;
          background: #76DEFF;
          border-right: 1px solid rgba(0, 48, 135, 0.12);
          padding: 28px 18px;
          flex-shrink: 0;
          transition: width .3s ease;
          box-shadow: 4px 0 20px rgba(93, 134, 148, 0.25);
        }
        ...
        .brand-icon {
          ...
          height: 44px;
          border-radius: 12px;
          background: rgba(20, 152, 254, 0.15);
          border: 1px solid rgba(0, 0, 0, 0.2);
          box-shadow: 0 3px 6px rgba(93, 134, 148, 0.4);
          display: flex;
          align-items: center;
        ...
        .menu-button.active {
          background: #005DFF;
          color: #ffffff;
          box-shadow: 0 4px 14px rgba(0, 93, 255, 0.35);
        }

        .logout-menu {
          margin-top: 30px;
          border-top: 1px solid rgba(0, 48, 135, 0.15);
          padding-top: 18px;
          color: #b91c1c;
        }
        .logout-menu:hover {
        ...
        .stat-icon {
          ...
          justify-content: center;
          font-size: 22px;
          box-shadow: 0 3px 8px rgba(0, 93, 255, 0.18);
        }
        ...
        .export-button {
          ...
          border: none;
          color: #ffffff;
          box-shadow: 0 3px 8px rgba(0, 93, 255, 0.3);
        }
        .export-button:hover {
          background: #004ecc;
        }
        ...
        td {
          font-size: 13px;
          padding: 13px 14px;
          border-bottom: 1px solid rgba(0, 93, 255, 0.08);
          color: #0f172a;
        }
      ...
      {showLogoutModal && (
        ...
        >
          <div className="logout-modal">
            ...
            <p>Apakah Anda yakin ingin keluar dari sesi Dashboard Admin BridgeCom?</p>
